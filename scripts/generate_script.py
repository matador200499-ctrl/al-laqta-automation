...
DEFAULT_TOPIC = "ليلة حب في القاهرة"
...
def build_prompt(topic: str) -> str:
    return f"""
اكتب كلمات أغنية مصرية أصلية مدتها نحو 60 إلى 90 ثانية عن: {topic}.
اجعلها أغنية بوب عاطفية قابلة للإلقاء والغناء بصوت عربي، وبها مقدمة قصيرة، كوبليه، لازمة سهلة التذكر، كوبليه ثانٍ، ثم خاتمة.
لا تقلّد أي فنان معروف ولا تستخدم كلمات من أغنية موجودة. اجعل كل مشهد مقطعًا غنائيًا قصيرًا، واجعل onscreen_text سطرًا بارزًا من الكلمات.

أعد JSON صحيح فقط بدون Markdown أو أي نص قبله أو بعده.
استخدم المفاتيح التالية فقط:
- title: عنوان عربي جذاب للأغنية لا يزيد عن 90 حرفًا
- description: وصف عربي قصير للأغنية والفيديو
- tags: قائمة من 3 إلى 5 وسوم موسيقية عربية
- scenes: قائمة من 6 أو 7 مشاهد

كل مشهد يجب أن يحتوي على:
- narration: كلمات المقطع الغنائي بالعامية المصرية، من سطرين إلى أربعة أسطر
- onscreen_text: سطر غنائي عربي واضح من 4 إلى 8 كلمات
...
قسّم الأغنية إلى 6 أو 7 مشاهد. اجعل مجموع الكلمات مناسبًا لنحو 60 إلى 90 ثانية، مع تكرار اللازمة مرة واحدة فقط ومن دون حشو.
