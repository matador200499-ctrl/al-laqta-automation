...
FALLBACK_TOPICS = [
    "سلسلة: عمر وليلى | الحلقة 1 | لقاء غير متوقع في آخر الليل",
    "سلسلة: سارة وآدم | الحلقة 1 | رسالة وصلت بعد فوات الأوان",
    "سلسلة: حكاية على الكورنيش | الحلقة 1 | نظرة غيّرت يومًا عاديًا",
    "سلسلة: بين قلبين | الحلقة 1 | مكالمة من رقم مجهول",
    "سلسلة: موعد في المطر | الحلقة 1 | المظلة التي جمعت شخصين",
    "سلسلة: آخر فرصة | الحلقة 1 | اعتذار لم يصل لصاحبه",
    "سلسلة: صدفة العمر | الحلقة 1 | مقعد فارغ في القطار",
    "سلسلة: بعد الغياب | الحلقة 1 | صورة قديمة تكشف سرًا"
...
CHANNEL_DESCRIPTION = os.environ.get(
    ...
    "قناة يوتيوب عربية تنشر قصصًا رومانسية ودرامية قصيرة مترابطة باللهجة المصرية، موجهة لجمهور عربي بالغ",
)
...
def generate_topics_with_groq() -> List[str]:
    ...
    prompt = (
        f"اقترح {TOPICS_TO_GENERATE} أفكار جديدة لحلقات قصص رومانسية ودرامية قصيرة مترابطة.\n"
