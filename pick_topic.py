...
FALLBACK_TOPICS = [
    "قصة صعود وسقوط إمبراطورية نوكيا: دروس في الابتكار",
    "تاريخ الذكاء الاصطناعي: من الخيال العلمي إلى الواقع",
    "كيف غيرت الثورة الصناعية وجه البشرية للأبد",
    "أسرار الحضارة المصرية القديمة التي لم تسمع عنها من قبل",
    "سباق الفضاء: القصة الكاملة للصراع بين القوى العظمى",
    "تطور الإنترنت: كيف وصلنا من صفحات بسيطة إلى الميتافيرس",
    "تاريخ النقود: من المقايضة إلى العملات الرقمية",
    "أعظم الاكتشافات الطبية التي أنقذت ملايين الأرواح",
    "كيف تعمل العقول العبقرية: تحليل لشخصية ليوناردو دا فينشي",
    "تأثير التغير المناخي على مستقبل المدن الساحلية"
]
...
CHANNEL_DESCRIPTION = os.environ.get(
    ...
    "قناة يوتيوب تنشر فيديوهات طويلة وعميقة (15 دقيقة) بالعربي في مجال عام ومثير للاهتمام",
)
...
def generate_topics_with_groq() -> List[str]:
    ...
    prompt = (
        f"اقترح {TOPICS_TO_GENERATE} موضوع جديد ومختلف لفيديو طويل (15 دقيقة).\n"
